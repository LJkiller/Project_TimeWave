...
/**
 * Method responsible of handling the sign up page request. 
 ...
 */
export async function handleSignUp(db, url, pathSegments, request, response){
    let route = 'tides';
    ResponseManager.sendPageRoute(route);
       
    try{
        let template = (await fs.readFile('templates/sign-up.sawcon')).toString();
